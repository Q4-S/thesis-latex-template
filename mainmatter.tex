...
% ============================================	
\newpage 
% or \clearpage for oneside
\cleardoublepage
% ===>>>>>> switch page number to Arabic numerals
...
\begin{figure}[h!]
    \centering
    \includegraphics[draft, width=0.3\textwidth, height=5cm]{nonexistent-image.png}
...
\begin{figure}[ht]
    \centering
    % \includegraphics[width=0.8\textwidth]{figure1.png}
    \fbox{\parbox{0.8\textwidth}{\centering\vspace{3in}Figure placeholder}}
...
\printbibliography     % list from file reference.bib and update setting.tex to configure
...
\vspace*{0cm}
\begin{center}
{\LARGE\bfseries (계층적 에너지 거래 관리를 위한 글로벌 파레토 탐색을 통합한 다중 군집 최적화 기술)}
\\[3\baselineskip]
{\LARGE {\bfseries \thesisauthor }}
\\[2\baselineskip]
{\large 전남대학교대학원 전기공학과\\[0.5\baselineskip] (지도교수 : 최용훈)}
\\[3\baselineskip]
\end{center}
