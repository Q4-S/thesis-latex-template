...
\usepackage[style=numeric]{biblatex}    % setting bibliografi style (alphabetic, authoryear, authortitle,numeric etc)
\addbibresource{reference.bib}          % calling file .bib

\usepackage{comment}            % comment or uncoment big area contents using \begin{comment} contents \end{comment}
