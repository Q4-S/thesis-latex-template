...
% See how Fonts worked in Apendix
% === MAIN FONTS (Default body text, paragraphs, normal content) ===
\setmainfont{Times New Roman}        % English in Times New Roman
\setmainhangulfont{UnBatang}[        % Korean main font, UnBatang only support bold 
  %BoldFont = NanumMyeongjo,         % Not all Korean font support bold, italic or bold italic
...
% Header and footer style, Learn manually by yourself if you want custom it :)
\pagestyle{fancy}
\fancyhf{}
%\fancyhead[C]{\thepage}
